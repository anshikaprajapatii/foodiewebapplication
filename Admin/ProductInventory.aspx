<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ProductInventory.aspx.cs" Inherits="Foodie.Admin.ProductInventory" %>
                                ...
                                <div class="card-block">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-8 col-lg-12 mobile-inputs">
                                            <h4 class="sub-title">Product Inventory</h4>
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cs %>" SelectCommand="SELECT g.GodownId, g.GodownName, g.GodownPin, p.ProductId, p.Name, p.Price, p.Quantity, p.IsActive FROM Godown g INNER JOIN Products p ON g.GodownId = p.GodownId"></asp:SqlDataSource>
                                                    <asp:Repeater ID="rProductInventory" runat="server" OnItemDataBound="rProductInventory_ItemDataBound">
                                                        <HeaderTemplate>
                                                            <table class="table data-table-export table-hover nowrap">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Godown Name</th>
                                                                        <th>Godown Pin Code</th>
                                                                        <th>Product Name</th>
                                                                        <th>Product Price</th>
                                                                        <th>Quantity</th>
                                                                        <th>Is Active</th>
